...
module.exports = function transformer(file, api) {
    ...
    for (var property in propertyRenameMap) {
        source = jscodeshift(source).findVariableDeclarators(property).renameTo(propertyRenameMap[property]).toSource();
    }
...
const shouldAttributeBeRenamed = path =>
    attributeBelongsToReactVirtualizedElement(path) && isAttributeInPropertyRenameMap(path);
