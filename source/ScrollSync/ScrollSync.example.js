...
export default class GridExample extends React.PureComponent {
    ...
    render() {
        const { columnCount, columnWidth, height, overscanColumnCount, overscanRowCount, rowHeight, rowCount } =
            this.state;
        ...
        return (
            <ContentBox>
                ...
                <ContentBoxParagraph>
                    This example shows two <code>Grid</code>s and one <code>List</code> configured to mimic a
                    spreadsheet with a fixed header and first column. It also shows how a scroll callback can be used to
                    control UI properties such as background color.
                </ContentBoxParagraph>
