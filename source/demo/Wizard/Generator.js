export default function Generator({
    ...
    const useCellMeasurer =
        !doNotVirtualizeColumns && !nonCheckerboardPattern && (!cellsHaveKnownHeight || !cellsHaveKnownWidth);
...
function getAutoSizer({ child, collectionHasFixedHeight, collectionHasFixedWidth }) {
    const props = {};
...
function getBaseComponent({ doNotVirtualizeColumns, hasMultipleColumns, nonCheckerboardPattern }) {
