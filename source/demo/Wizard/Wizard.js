...
export default class Wizard extends React.Component {
            ...
            <div className={styles.Wrapper}>
                <ContentBox>
                    ...
                    <Option
                        ...
                        onChange={hasMultipleColumns => this.updateState({ hasMultipleColumns })}
                    />
                    <Option
                        checked={doNotVirtualizeColumns}
                        disabled={!hasMultipleColumns}
                        label="Should all your columns be visible at once?"
                        onChange={doNotVirtualizeColumns => this.updateState({ doNotVirtualizeColumns })}
                    />
                    <Option
                        ...
                        onChange={nonCheckerboardPattern => this.updateState({ nonCheckerboardPattern })}
                    />
                    <Option
                        ...
                        onChange={collectionHasFixedHeight => this.updateState({ collectionHasFixedHeight })}
                    />
                    <Option
                        disabled={!hasMultipleRows && !hasMultipleColumns}
                        checked={collectionHasFixedWidth}
                        label="Does your collection have a fixed width?"
                        onChange={collectionHasFixedWidth => this.updateState({ collectionHasFixedWidth })}
                    />
                </ContentBox>
                <ContentBox>
                    ...
                    <Option
                        ...
                        onChange={cellsHaveKnownHeight => this.updateState({ cellsHaveKnownHeight })}
                    />
                    <Option
                        disabled={
                            nonCheckerboardPattern ||
                        ...
                        onChange={cellsHaveKnownWidth => this.updateState({ cellsHaveKnownWidth })}
                    />
                    <Option
                        ...
                        onChange={cellsHaveUniformHeight => this.updateState({ cellsHaveUniformHeight })}
                    />
                    <Option
                        ...
                        onChange={cellsHaveUniformWidth => this.updateState({ cellsHaveUniformWidth })}
                    />
                </ContentBox>
                <ContentBox>
                    <ContentBoxHeader text="Suggested Starting Point" />
                    <CodeMirror options={codeMirrorOptions} value={markup} key={this.state.key} />
                </ContentBox>
            </div>
        );
    }
    ...
    _sanitizeState() {
        ...
        return {
            ...
            cellsHaveKnownWidth,
            cellsHaveUniformHeight:
                cellsHaveUniformHeight && hasMultipleRows && !nonCheckerboardPattern && cellsHaveKnownHeight,
            cellsHaveUniformWidth:
                cellsHaveUniformWidth && hasMultipleColumns && !nonCheckerboardPattern && cellsHaveKnownWidth,
            collectionHasFixedHeight,
            collectionHasFixedWidth,
