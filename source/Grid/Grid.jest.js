...
describe("Grid", () => {
    ...
    describe("styles, classNames, ids, and roles", () => {
        ...
        it("should use a custom :containerStyle if specified", () => {
            ...
            expect(
                rendered.querySelector(".ReactVirtualized__Grid__innerScrollContainer").style.backgroundColor,
            ).toEqual("red");
        });
    ...
    describe("autoContainerWidth", () => {
        ...
        it("should set the innerScrollContainer width to :totalColumnsWidth unless :autoContainerWidth", () => {
            ...
            const rendered = findDOMNode(render(getMarkup(props)));
            expect(rendered.querySelector(".ReactVirtualized__Grid__innerScrollContainer").style.width).toEqual(
                "2500px",
            ); // 50 columns x 50px
        });
    });
    ...
    describe("autoHeight", () => {
        ...
        it("should have innerScrollContainer height to be equal number of rows * rowHeight", () => {
            ...
            expect(rendered.querySelector(".ReactVirtualized__Grid__innerScrollContainer").style.height).toEqual(
                "2000px",
