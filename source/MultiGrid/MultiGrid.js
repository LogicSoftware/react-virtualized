...
class MultiGrid extends React.PureComponent {
    ...
    _columnWidthRightGrid = ({ index }) => {
        ...
        if (showVerticalScrollbar && index === columnCount - fixedColumnCount) {
    ...
    _renderBottomLeftGrid(props) {
        ...
        const scrollbarSize = this.state.showVerticalScrollbar ? this.state.scrollbarSize : 0;
        const gridWidth = hideBottomLeftGridScrollbar ? width + scrollbarSize : width;
    ...
    _renderTopRightGrid(props) {
        ...
        const additionalHeight = this.state.showHorizontalScrollbar ? scrollbarSize : 0;
